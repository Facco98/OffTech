...
ssh client.facchinetti-dns.offtech "sudo apt install traceroute -y; traceroute 10.1.1.3 >> dns/part2_client.txt"
ssh cache.facchinetti-dns.offtech "sudo apt install traceroute -y; traceroute 10.1.2.3 >> dns/part2_cache.txt"
